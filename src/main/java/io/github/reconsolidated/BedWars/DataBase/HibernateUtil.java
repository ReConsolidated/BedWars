    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://104.248.133.113:3306/hibernate_db?allowPublicKeyRetrieval=true&useSSL=false&createDatabaseIfNotExist=true");
                settings.put(Environment.USER, "gracjan6");
                settings.put(Environment.PASS, "kpwCo6");
